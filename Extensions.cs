...
namespace Flamingo
{
    static class Extensions
    {
        ...
        {
			pm.pierce = pierce;
			pm.maxPierce = infiniteMax? 999999999999999999 : pierce;
			pm.CapPierce(infiniteMax ? 999999999999999999 : pierce);
		...
		{
			dm.damage = damage;
			dm.maxDamage = infiniteMax ? 999999999999999999 : damage;
			dm.CapDamage(infiniteMax ? 999999999999999999 : damage);
