...
namespace Flamingo
{
    ...
    class Main : BloonsMod
    {
        ...
        public class Flamingo : ModTower
        {
            public override string Name => "Flamingo";
            public override string DisplayName => "Flamingo";
            public override string Description => "Every Time i can get Powers in a Game i'm OP";
            ...
            public override string Icon => "Flamenco_Icon";
            public override string Portrait => "Flamenco_Portrait";
        }
        public class AbuseGameSystem : ModUpgrade<Flamingo>
        {
            public override string Name => "AbuseGameSystem";
            public override string DisplayName => "Abuse Game System";
            public override string Description => "whoopsies";
            public override int Cost => 99999999;
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                bananaGunProj.AddBehavior(new DamageModel("DamageModel_", 999999999, 999999999, true, true, true, BloonProperties.None, BloonProperties.None));
                towerModel.range = 999999999;
                attackModel.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.GetBehavior<DamageModel>().damage = 999999999;
                attackModel.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.pierce = 999999999;
                attackModel.weapons[0].Rate = 0;
            }
            public override string Icon => "Flamenco";
            public override string Portrait => "Flamenco";
        }
            ...
            public static void Postfix()
            {
                ...
                try
                {
                    foreach (var tts in InGame.Bridge.GetAllTowers())
                    {
                        ...
                        if (!tts.namedMonkeyKey.ToLower().Contains("Flamingo")) continue;
